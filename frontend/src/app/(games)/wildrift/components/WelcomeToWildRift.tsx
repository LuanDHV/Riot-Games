...
export default function WelcomeToWildRift() {
  return (
    <>
      <div className="h-[45px] w-full bg-[url('/imgs/wildrift/welcometowildrift/welcome-to-wild-rift-background.png')] bg-cover bg-center md:h-[72px] lg:h-[115px] xl:h-[175px]"></div>
      <div className="flex flex-col items-center gap-16 bg-[url('/imgs/wildrift/welcometowildrift/welcome-to-wild-rift-background-2.png')] bg-cover bg-center p-6 md:p-8 lg:flex-row lg:p-12 xl:px-[200px]">
      ...
      <div className="h-[45px] w-full bg-[url('/imgs/wildrift/welcometowildrift/welcome-to-wild-rift-background-3.png')] bg-cover bg-center md:h-[72px] lg:h-[115px] xl:h-[175px]"></div>
    </>
  );
}
