...
export default function Collision() {
  return (
    <>
      <div className="flex min-h-[480px] w-full items-center bg-[url('/imgs/valorant/collision/collision-background.png')] bg-cover bg-center p-6 md:p-8 lg:min-h-[640px] xl:px-[200px]">
