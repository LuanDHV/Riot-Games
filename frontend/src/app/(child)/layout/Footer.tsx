...
export default function Footer() {
  ...
  const arcaneFooter: IFooterData[] = [
    {
      section1: [],
      socials: [
        { icon: "/imgs/footer/tiktok-icon.png", alt: "Tiktok", link: "#" },
        ...
        { icon: "/imgs/footer/facebook-icon.png", alt: "Facebook", link: "#" },
        { icon: "/imgs/footer/youtube-icon.png", alt: "YouTube", link: "#" },
        { icon: "/imgs/footer/spotify-icon.png", alt: "Spotify", link: "#" },
      ],
      icons: [
        {
          icon: "/imgs/footer/riotgames-icon.png",
      ...
      descriptions: [
        {
          text: "© 2021-2024 Riot Games, Inc. ARCANE LEAGUE OF LEGENDS and any associated logos are trademarks, service marks, and/or registered trademarks of Riot Games, Inc",
        },
      ],
      section2: [
        { title: "Privacy Notice", link: "#" },
