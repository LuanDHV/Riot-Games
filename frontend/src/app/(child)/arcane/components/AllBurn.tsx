export default function AllBurn() {
  return (
    <>
      <div className="flex min-h-[650px] flex-col items-center justify-center gap-16 bg-[url('/imgs/arcane/allburn/all-burn-background.png')] bg-cover bg-center p-6 md:p-8 lg:flex-row lg:p-12 xl:px-[200px]">
