      ...
      <div className="relative h-auto w-full overflow-hidden pt-20">
        ...
        >
          ...
          <div className="flex">
            {Products?.filter(
              (prod: IProducts) =>
                prod.category === product.category && prod.id !== product.id, //Show products in the same category except the current product
            ).map((prod: IProducts) => (
              <div key={prod.id} className="w-full p-4 lg:w-1/4">
                <div className="flex flex-col items-center justify-center">
                  ...
                  />
                  <h3 className="mt-2 text-xl font-bold">{prod.name}</h3>
                  <p className="text-lg text-gray-700">${prod.price}</p>
                </div>
              </div>
            ))}
          </div>
