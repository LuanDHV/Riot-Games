  ...
  return (
    <>
      <div className="flex h-auto w-full flex-col md:flex-row lg:px-0 lg:pt-0">
        <div className="flex w-full lg:w-1/2 xl:justify-end">
          <div className="mx-auto flex h-full w-full flex-col items-center justify-center px-4 pt-20 md:max-w-[620px] lg:px-[30px] xl:mx-0">
            ...
            <div className="mb-10 flex w-full gap-5">
              <Link href="#" className="w-1/2 text-center">
                <div className="flex h-36 w-full flex-col justify-center rounded-lg bg-[#adacaa33] p-6 duration-300 ease-in-out hover:bg-[#8080804d]">
            ...
            <Link
              href="#"
              className="mx-auto mb-10 flex h-16 w-full max-w-[450px] items-center justify-center rounded-3xl bg-[#d1363a] duration-300 ease-in-out hover:bg-[#da5e61] md:max-w-[260px]"
            >
