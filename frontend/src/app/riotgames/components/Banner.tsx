export default function Banner() {
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="absolute inset-0 flex h-full w-full flex-row items-start justify-center px-5 text-white md:px-10 lg:pl-20">
        <div className="flex h-full w-full flex-col items-center justify-center gap-10 lg:w-2/6">
          ...
          {/* Button Play Now */}
          <button className="flex h-[50px] w-[184px] items-center justify-evenly rounded-2xl bg-gradient-to-br from-blue-500 to-blue-400 px-3 duration-300 ease-in-out hover:shadow-lg hover:shadow-blue-500 hover:brightness-125 lg:h-[72px] lg:w-[244px]">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-black lg:h-12 lg:w-12">
              <img src="/imgs/riotgames/arrow-right.png" alt="arrow-right" />
            </div>
